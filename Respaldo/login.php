...
<div class="d-lg-flex half">
    <div class="bg order-1 order-md-2" style="background-image: url('features-1.png');"></div>
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-md-7">
                    ...
                    <form id="form" >
                        ...
                        <input id="btn-login" type="submit" value="Login" class="btn btn-block btn-primary">
